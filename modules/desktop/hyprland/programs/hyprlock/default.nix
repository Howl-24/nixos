    ...
    (_: {
      programs.hyprlock = {
        ...
        settings = {
          ...
          background = if opts.hyprlock.monitor2 == "" then [{
            monitor = opts.hyprlock.monitor1;
            color = "rgb(36, 39, 58)";
            path = "${../../../themes/wallpapers/${opts.hyprlock.background1}}";
          ...
          }] else [
            {
              ...
              color = "rgb(36, 39, 58)";
              path =
                "${../../../themes/wallpapers/${opts.hyprlock.background1}}";
              new_optimizations = true;
              blur_size = 3;
              blur_passes = 2;
              noise = 1.17e-2;
            ...
            }
            {
              ...
              color = "rgb(36, 39, 58)";
              path =
                "${../../../themes/wallpapers/${opts.hyprlock.background2}}";
              new_optimizations = true;
              blur_size = 3;
              blur_passes = 2;
              noise = 1.17e-2;
          ...
          label = if opts.hyprlock.monitor2 == "" then [{
            monitor = opts.hyprlock.monitor1;
            text = "$TIME";
            font_size = 64;
